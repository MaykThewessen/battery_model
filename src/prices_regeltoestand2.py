...
df = pd.read_csv('Entsoe_prices_NL/outfile_imb_15min_NL_20240101_to_20241220.csv', parse_dates=['time_stamp'])
...
df.to_csv('Entsoe_prices_NL/outfile_imb_15min_NL_20240101_to_20241220_reg2.csv', index=False)
